...
| How the token is read | [conformancelab.md](conformancelab.md#reading-a-token) |
...
| A stub answers on a different address | [conformancelab.md](conformancelab.md#a-stub-answers-on-a-different-address) |
