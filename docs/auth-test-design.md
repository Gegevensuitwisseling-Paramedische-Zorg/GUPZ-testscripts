...
| Two modes, and why that does not double the set | [open-points.md OP-01](open-points.md#op-01-401-against-403) |
| What this set does not cover | [requirements.md](requirements.md#what-no-testscript-covers) |
| What still has to happen | [requirements.md](requirements.md#cases-still-to-build), [open-points.md](open-points.md) |
